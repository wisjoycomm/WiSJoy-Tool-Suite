	...
	*/
	public class DataManager : SingletonMonoBehaviour<DataManager>
	{
        ...
        */
		...
		#region Detail Generators
		public string Ver { get => VersionData.Ver; set => VersionData.Ver = value; }
		public int VerCode { get => VersionData.VerCode; set => VersionData.VerCode = value; }
		public string Name { get => PlayerData.Name; set => PlayerData.Name = value; }
		public string DeviceName { get => DeviceInfo.DeviceName; set => DeviceInfo.DeviceName = value; }
		public string DeviceModel { get => DeviceInfo.DeviceModel; set => DeviceInfo.DeviceModel = value; }
		public string DeviceType { get => DeviceInfo.DeviceType; set => DeviceInfo.DeviceType = value; }
		public string DeviceSystem { get => DeviceInfo.DeviceSystem; set => DeviceInfo.DeviceSystem = value; }
		public string DeviceSystemVersion { get => DeviceInfo.DeviceSystemVersion; set => DeviceInfo.DeviceSystemVersion = value; }
		public string DeviceUniqueIdentifier { get => DeviceInfo.DeviceUniqueIdentifier; set => DeviceInfo.DeviceUniqueIdentifier = value; }
		#endregion
