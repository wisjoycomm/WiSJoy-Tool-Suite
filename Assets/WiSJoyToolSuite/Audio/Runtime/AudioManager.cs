...
namespace WiSJoy.Audio
{
    public class AudioManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            MessageBus.I.Subscribe<AudioEvent>(ChangeAudio, MessageChannel.audio);
            MessageBus.I.Subscribe<MusicEvent>(PlayMusic, MessageChannel.audio);
            MessageBus.I.Subscribe<SFXEvent>(Shot, MessageChannel.audio);
        }

        private void OnDestroy()
        {
            MessageBus.I.Unsubscribe<AudioEvent>(ChangeAudio, MessageChannel.audio);
            MessageBus.I.Unsubscribe<MusicEvent>(PlayMusic, MessageChannel.audio);
            MessageBus.I.Unsubscribe<SFXEvent>(Shot, MessageChannel.audio);
        }
        #endregion
